...
function startEditTariff(node) {
    ...
    var priceCoef = record.find(':nth-child(3)').eq(0);
    var idlePriceCoef = record.find(':nth-child(4)').eq(0);
    ...
    var priceCoefVal = priceCoef.eq(0).text();
    priceCoef.eq(0).text('');
    priceCoef.eq(0).html(textInput);
    priceCoef.eq(0).find(':nth-child(1)').val(priceCoefVal);

    var idlePriceCoefVal = idlePriceCoef.eq(0).text();
    idlePriceCoef.eq(0).text('');
    idlePriceCoef.eq(0).html(textInput);
    idlePriceCoef.eq(0).find(':nth-child(1)').val(idlePriceCoefVal);

    var manage = record.find(':nth-child(5)').eq(0);
