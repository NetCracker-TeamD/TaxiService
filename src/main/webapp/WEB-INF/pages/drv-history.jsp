                    ...
                    <div class="panel-body">
                      <ul class="list-group">
                        ...
                        <li class="list-group-item"><b>Date:</b> <fmt:formatDate type="date"
                                                                                 value="${route.order.executionDate}" /></li>
                        <li class="list-group-item"><b>Service type:</b> Cargo taxi</li>
                        <li class="list-group-item"><b>Method of payment:</b> ${route.order.paymentType.name()}</li>
                        <li class="list-group-item"><b>Cost of payment:</b> <%--${route.price}--%> UAH</li>
