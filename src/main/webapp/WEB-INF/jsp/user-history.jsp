  ...
  <div class="jumbotron">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <c:forEach  items="${orderList}" var="route">
            ...
            <div id="history_node" class="panel-heading">
              <div class="row">
                ...
                <div class="col-sm-3"><fmt:formatDate pattern="MMM dd, yyyy k:mm"
                                                      value="${route.executionDate}" /></div>
                <div class="col-sm-3"><%--${route.price}--%> UAH</div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                      <ul class="list-group">
                        <li class="list-group-item"><b>Tracking num:</b> ${route.id}</li>
                        <li class="list-group-item"><b>Date:</b> <fmt:formatDate type="date"
                                                                                 value="${route.executionDate}" /></li>
                        <li class="list-group-item"><b>Service type:</b> Cargo taxi</li>
                        <li class="list-group-item"><b>Method of payment:</b> ${route.paymentType.name()}</li>
                        <li class="list-group-item"><b>Cost of payment:</b> <%--${route}--%> UAH</li>
                        <li class="list-group-item"><b>Comment:</b> ${route.comment}</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                      <ul class="list-group">
                        <li class="list-group-item"><b>Car category: </b> Vans</li>
                        <li class="list-group-item"><b>Sex of driver:</b> Male</li>
                        <c:forEach items="${route.features}" var="feature">
                          <li class="list-group-item"><b>${feature.name}: </b><span class="glyphicon glyphicon-ok-sign"></span></li>
                        </c:forEach>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                      <table class="table table-striped">
                        ...
                        <tbody>
                        <c:forEach var="r" items="${route.routes}">
                          <tr>
                            <td><fmt:formatDate pattern="MMM dd, yyyy k:m"
                                                value="${r.startTime}" /></td>
