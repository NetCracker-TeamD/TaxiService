                            ...
                            <div id="queue_order1" class="panel-info panel-group" style="margin: 0px">
                                ...
                                <div id="queue_order2" class="panel-heading">
                                    <div class="row" >
                                        ...
                                        <div class="col-sm-3">
                                            <fmt:formatDate pattern="MM dd, yyyy k:mm" value="${order.executionDate.time}"/>
                                        </div>
                                ...
                                <div id="freeRoute"  class="panel-body" style="padding: 0px; display:none;">
                                    <div class="panel">
                                            ...
                                            <thead>
                                                ...
                                                <c:forEach items="${order.routes}" var = "route">
                                                    <tr class="info">
                                                        ...
                                                        <td class="col-sm-2">${route.distance}</td>
                                                        <td class="col-sm-1">${route.status}</td>
                                                        <td class="col-sm-2">
                                                            <div>
                                                                <a class="btn btn-success" href="order?route=${route.id}&driver=${driver.id}"><i class="glyphicon glyphicon-plus"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                ...
                <div class="col-md-3 pull-right">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body col">
                            <form:form method="GET" action="queue">
                                <c:forEach items="${services}" var="service">
                                    <input type="checkbox" name="${service.id}" id="service${service.id}">
