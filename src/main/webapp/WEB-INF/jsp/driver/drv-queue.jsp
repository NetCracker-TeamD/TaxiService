    ...
    <div class="jumbotron row">
                ...
                <tbody>
                    <c:forEach items="${orderList}" var="order">
                        <tr  class="info"  data-toggle="collapse" data-target="#collapseExample"  >
                            ...
                            <td>
                                <button type="button"  data-toggle="modal" data-target="#orderDetail"  data-whatever="ID" class="btn btn-info" title="View details"><i class="glyphicon glyphicon-eye-open"></i></button>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div class="col-md-3 pull-right">
            <div class="panel panel-primary">
                ...
                <div>
                <label class="radio-inline">
                    <input type="checkbox" name="non_smoking" id="non_smoking" value="non_smoking"> Non-smoking
                </label>
                </div>
                <div>
                <label class="radio-inline">
                ...
                <div>
                <label class="radio-inline">
                    <input type="checkbox" name="foodstuff_delivery" id="foodstuff_delivery" value="foodstuff_delivery"> Foodstuff delivery
                </label>
                </div>
...
<div class="modal fade" id="orderDetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            <tr class="info">
                                ...
                                <td>
                                    <div>
                                        <a class="btn btn-success" href="current-order.jsp"><i class="glyphicon glyphicon-plus"></i></a>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="orderDetail1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
