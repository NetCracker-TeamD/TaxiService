      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="active"><a href="#">Class car tariffs</a></li>
          </ul>
        </li>
        <li class="dropdown">
  ...
  <div class="table-responsive">
    <table class="table table-striped table-hover">
      ...
      <tr>
        ...
        <th>Name</th>
        <th>Price Coef</th>
        <th>Idle Price coef</th>
        <th>Manage</th>
      </tr>
      </thead>
      <tbody>
      <%int num = 1;%>
      <c:forEach var="tariff" items="${carClasses}">
        <tr>
          <td>
            <%=num++%>
          </td>
...
<script type="application/javascript" src="/pages/resources/project/js/admin/carTariffs.js"></script>
</body>
